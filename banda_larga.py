...
hist.update_layout(xaxis = dict(linecolor='rgba(0,0,0,1)', # adicionando linha em y = 0
                                tickmode = 'array', # alterando o modo dos ticks
                                tickvals = hist_acesso['ano_mes'], # setando a posição do tick de x
                                ticktext = hist_acesso['ano_mes']),# setando o valor do tick de x
